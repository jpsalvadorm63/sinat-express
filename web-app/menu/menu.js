...
jQuery(function() {
    ...
    if (!($.browser.msie && $.browser.version < 7)){
        $('ul ul a', '#menu').css({background: 'none'}).hover(
            function(){ $(this).css({backgroundColor: 'rgb(150,168,147)'}).animate({backgroundColor: 'rgb(239,222,62)'}, 500); },
            function(){ $(this).animate({backgroundColor: 'rgb(150,168,147)'}, {duration : 300, complete : function(){
