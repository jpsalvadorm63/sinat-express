...
<body>
    ...
    <a href="#list-fichaCampo" class="skip" tabindex="-1">
    ...
    <div id="list-fichaCampo" class="scaffold-list" role="main">
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <g:sortableColumn property="statusControl" title="Control" />
                </tr>
            </thead>
            <tbody>
                <g:each in="${fichaCampoInstanceList}" status="i" var="fichaCampoInstance">
                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                        ...
                        <td>
                            <g:link action="show" id="${fichaCampoInstance.id}">
                                ${fieldValue(bean: fichaCampoInstance, field: "codigoCatastral")}
                            </g:link>
                        </td>
                        ...
                        <td>${fieldValue(bean: fichaCampoInstance, field: "origen")}</td>
                        <td>${fieldValue(bean: fichaCampoInstance, field: "statusControl")}</td>
                    </tr>
                </g:each>
            </tbody>
        </table>
