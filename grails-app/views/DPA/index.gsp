...
<html>
    ...
    <div id="menu">
      <ul class="menu">
		...
		<div id="provincias" class="content scaffold-list" role="main">
            ...
            <td class="link1"><g:remoteLink action="cantones" id="${fieldValue(bean: DPAInstance, field: "codigo")}" update="cantonesLista">+</g:remoteLink></td>
					</tr>
				</g:each>
				</tbody>
			</table>
    ...
    <div id="parroquias" class="content scaffold-list" role="main">
      <h1 style="">Parroquias</h1>
      <div id="parroquiasLista"></div>
    </div>
