...
class DPALP {
  ...
  String getNombreYCodigo() { nombre + ' (' + codigo + ')' }

  static transients = ['nombreYCodigo']

  static constraints = {
    codigo(size:1..6,nullable:false,unique:true)
    nombre(size:1..80,nullable:false,unique:false)
    nivel(sise:1..16,nullable:false,inList:['PROVINCIA','CANTON','PARROQUIA','ZONA','SECTOR','MANZANA'])
    ...
    appUsuario(nullable: true, maxSize: 64)
  ...
  static void fillData() {
    ...
    Map dpaCantones = ['0916':'SAMBORONDON','1601':'PASTAZA','0501':'LATACUNGA','1407':'HUAMBOYA',
                       ...
                       '1509':'CARLOS JULIO AROSEMENA TOLA','0406':'SAN PEDRO DE HUACA','1406':'SUCUA','1909':'PAQUISHA', '2302':'LA CONCORDIA' ]

    dpaCantones.each {dpac ->
      String codigo = dpac.key
      String nombre = dpac.value
      String codigoProvincia = codigo.substring(0,2)
      def provincia = DPALP.findByCodigoAndNivel(codigoProvincia,'PROVINCIA')
      def elcanton = DPALP.findByCodigoAndNivel(codigo,'CANTON')
      if(provincia && !elcanton) {
        def canton = new DPALP()
        canton.nivel = 'CANTON'
    ...
    Map dpaParroquias
    dpaParroquias = ['080352':'DAULE','030160':'TADAY','030361':'ZHUD','080252':'ATAHUALPA (CAB. EN CAMARONES)','080751':'CHONTADURO','092350':'CORONEL MARCELINO MARIDUEÑA (SAN CARLOS)','100455':'SAN JOSE DE QUICHINCHE','111158':'SELVA ALEGRE','140351':'INDANZA','180652':'YANAYACU - MOCHAPATA (CAB. EN YANAYACU)','210153':'GENERAL FARFAN',
                     ...
                     '210160':'10 DE AGOSTO', '170202':'CAYAMBE', '170256':'SAN JOSE DE AYORA', '060302':'SICALPA','230250':'LA CONCORDIA, CABECERA CANTONAL','230251':'MONTERREY','230252':'LA VILLEGAS','230253':'PLAN PILOTO','111356':'CAZADEROS']

    dpaParroquias.each {dpapr ->
      String codigo = dpapr.key
      String nombre = dpapr.value
      String codigoCanton = codigo.substring(0,4)
      def canton = DPALP.findByCodigoAndNivel(codigoCanton,'CANTON')
      def laparroquia = DPALP.findByCodigo(codigo)
      if(canton && !laparroquia) {
        def parroquia = new DPALP()
  ...
  static def cantones(DPALP provincia) {
    return findAllByNivelAndSuperior('CANTON',get(provincia.id),[sort:'nombre'])
  }

  static def parroquias(DPALP canton) {
